...
namespace DoctrineProxies\__CG__\OmekaSDomainManager\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DomainSiteMapping extends \OmekaSDomainManager\Entity\DomainSiteMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DomainSiteMapping $proxy) {
    ...
    public function getSitePageId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSitePageId', []);

        return parent::getSitePageId();
    }
    ...
    public function setSiteId($site_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSiteId', [$site_id]);
